...
public class DownloadInfo {
    public static class Reader {
        ...
        public void updateFromDatabase(DownloadInfo info) {
            ...
            info.mNumFailed = getInt(DownloadConstants.FAILED_CONNECTIONS);
            int retryRedirect = getInt(DownloadConstants.RETRY_AFTER_X_REDIRECT_COUNT);
            ...
            info.mETag = getString(info.mETag, DownloadConstants.ETAG);
            ...
            //add for appstore
            info.mPackageName = getString(info.mPackageName, Downloads.COLUMN_PACKAGE_NAME);
            info.mMd5 = getString(info.mPackageName, Downloads.COLUMN_MD5);
            info.mResource = getInt(Downloads.COLUMN_SOURCE);
            synchronized (this) {
    ...
    public long restartTime(long now) {
        ...
        return mLastMod +
                DownloadConstants.RETRY_FIRST_DELAY *
    ...
    private int checkIsNetworkTypeAllowed(int networkType) {
     ...
     //           return NETWORK_TYPE_DISALLOWED_BY_REQUESTOR;   cancel it for appstore
            }
        }
