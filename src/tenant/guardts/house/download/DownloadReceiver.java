...
public class DownloadReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
        ...
        } else if (action.equals(DownloadConstants.ACTION_RETRY)) {
            startService(context);
        } else if (action.equals(DownloadConstants.ACTION_OPEN)
                || action.equals(DownloadConstants.ACTION_LIST)
                || action.equals(DownloadConstants.ACTION_HIDE)) {
