...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "tenant.guardts.house.download";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "tenant.guardts.house.download.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "tenant.guardts.house.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "tenant.guardts.house.download.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "tenant.guardts.house.download.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "tenant.guardts.house.download.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * tenant.guardts.house.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED.
     * <P>
     * Type: INTEGER
     * </P>
     * <P>
    ...
    public static final int STATUS_DATABASE_INSTALLED = 260;
    ...
    /**
     * DownloadConstants related to HTTP request headers associated with each download.
     */
