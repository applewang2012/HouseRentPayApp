...
public class wxfufeiActivity extends BaseActivity implements  DataStatusInterface{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new HoursePresenter(wxfufeiActivity.this, this);
        initSuccessView();
        //completeHouseRentAttributeInfo("465");
        //ini
    }
    ...
    private void initSuccessView(){
        ...
        mFinishPay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				completeHouseRentAttributeInfo("631");
...
//				}
    ...
    private void completeHouseRentAttributeInfo(String id){
		...
		String url = CommonUtil.mTestHost+"Services.asmx?op=CompleteRentAttribute";
    ...
    private void addBillLogRequestInfo(String renterId, String ownerId, String fee, String type){
		...
		String url = CommonUtil.mTestHost+"Services.asmx?op=AddBillLog";
    ...
    private void updateWalletRequestInfo(String idcard, String fee){
		...
		String url = CommonUtil.mTestHost+"Services.asmx?op=UpdateUserWallet";
    ...
    private void updateOrderInfo(String id){
		...
		String url = CommonUtil.mTestHost+"Services.asmx?op=UpdateOrderInfo";
