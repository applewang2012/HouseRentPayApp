...
package tenant.guardts.house.zxingview;
  ...
  public void onDraw(Canvas canvas) {
	//中间的扫描框，你要修改扫描框的大小，去CameraManager里面修改  
      ...
      if (resultBitmap != null) {  
         ...
         // canvas.drawText(getResources().getString(R.string.), frame.left, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);  
