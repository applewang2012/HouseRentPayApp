...
public class SurfaceViewTestActivity extends Activity implements MediaPlayer.OnCompletionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayFilePath = getIntent().getStringExtra("download_adv");
        initViews();
    }
    ...
    public void initViews() {
        ...
        // 设置Holder类型,该类型表示surfaceView自己不管理缓存区,虽然提示过时，但�?好还是要设置
    ...
    public void playVideo() {
        ...
        //Uri uri = Uri.parse("http://n2.vod01.icntvcdn.com/newtv2/2016/11/01/xajh20161009/xajh20161009.m3u8");
        Uri uri = Uri.parse("http://p.vod05.icntvcdn.com/media/new/2013/icntv2/media/2016/03/21/gongyiguoshijia.ts");
        try {
        	if (mPlayFilePath != null){
        		mediaPlayer.setDataSource(mPlayFilePath);
            ...
            // 设置异步加载视频，包括两种方�? prepare()同步，prepareAsync()异步
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        // 设置控制�?,放在加载完成以后设置，防止获取getDuration()错误
        ...
        public void run() {
            ...
            try {
                ...
                while (seekBarAutoFlag) {
                    /*
                     * mediaPlayer不为空且处于正在播放状�?�时，使进度条滚动�??
                     * 通过指定类名的方式判断mediaPlayer防止状�?�发生不�?�?
                     */
                	Thread.sleep(100);
...
public void onConfigurationChanged(Configuration newConfig) {
    ...
    protected void onDestroy() {
        super.onDestroy();
        // 由于MediaPlay非常占用资源，所以建议屏幕当前activity�?毁时，则直接�?�?
        try {
    ...
    public String getShowTime(long milliseconds) {
        ...
        // 判断是否大于60分钟，如果大于就显示小时。设置日期格�? //7123840 
...
//                // 获取当前视频指定位置的截�?,时间参数的单位是微秒,做了*1000处理
