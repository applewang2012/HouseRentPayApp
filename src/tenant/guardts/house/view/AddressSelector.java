...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    private int TextSelectedColor = Color.parseColor("#2894ff");
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = Color.parseColor("#2894ff");
    //列表icon资源
    ...
    private class Line extends LinearLayout{
        ...
        private int SelectedColor = Color.parseColor("#2894ff");
