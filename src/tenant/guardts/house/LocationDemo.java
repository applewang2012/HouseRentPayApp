...
//				startActivityForResult(openCameraIntent, 0);
    ...
    public void initOverlay() {
        ...
        if (index == 0){
        	options = new MarkerOptions().position(llA).icon(bdA)
                    .zIndex(9).draggable(false);
        }else if (index == 1){
        	options = new MarkerOptions().position(llA).icon(bdB)
                    .zIndex(9).draggable(false);
        }else if (index == 2){
        	options = new MarkerOptions().position(llA).icon(bdC)
                    .zIndex(9).draggable(false);
        }else if (index == 3){
        	options = new MarkerOptions().position(llA).icon(bdD)
                    .zIndex(9).draggable(false);
        }else if (index == 4){
        	options = new MarkerOptions().position(llA).icon(bdD)
                    .zIndex(9).draggable(false);
        }else if (index == 5){
        	options = new MarkerOptions().position(llA).icon(bdF)
                    .zIndex(9).draggable(false);
        }else if (index == 6){
        	options = new MarkerOptions().position(llA).icon(bdG)
                    .zIndex(9).draggable(false);
        }else if (index == 7){
        	options = new MarkerOptions().position(llA).icon(bdH)
                    .zIndex(9).draggable(false);
        }else if (index == 8){
        	options = new MarkerOptions().position(llA).icon(bdI)
                    .zIndex(9).draggable(false);
        }else if (index == 9){
        	options = new MarkerOptions().position(llA).icon(bdJ)
                    .zIndex(9).draggable(false);
        }else{
        	options = new MarkerOptions().position(llA).icon(bdA)
                    .zIndex(9).draggable(false);
