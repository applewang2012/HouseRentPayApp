...
//				registerUserName();
				...
				file = ScreenShotUtil.createScreenshotDirectory(RegisterUserStep1Activity.this);
	...
	private void startLiveIdentifyActivity(){
		authentic = DetectionAuthentic.getInstance(RegisterUserStep1Activity.this, new ResultListener() {
...
//			img.setImageBitmap(bm);
		...
		authentic.autenticateToCaptureAction(RegisterUserStep1Activity.this, mRealName, mIdCard);
	}
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 100){
				...
				Intent intent = new Intent(RegisterUserStep1Activity.this, HomeActivity.class);
