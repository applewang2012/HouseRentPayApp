 ...
 */
public class DownloadStartItem extends RelativeLayout {
    ...
    public DownloadStartItem(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initialize();
    }

    public DownloadStartItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();
    }

    public DownloadStartItem(Context context) {
        super(context);
        initialize();
    }
