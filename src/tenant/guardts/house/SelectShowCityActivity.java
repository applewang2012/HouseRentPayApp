...
//			adapter.notifyDataSetChanged();
	...
	public class ListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { // 定位
				convertView = inflater.inflate(R.layout.select_city_frist_list_item, null);
...
//				convertView = inflater.inflate(R.layout.select_city_recent_city, null);
...
//				recentHint.setText("最近访问的城市");
				...
				convertView = inflater.inflate(R.layout.select_city_total_item, null);
...
//		mLocationClient.stop();
	...
	class HotCityAdapter extends BaseAdapter {
		...
		@Override
		public View getView(int position, View convertView, ViewGroup parent) {
			convertView = inflater.inflate(R.layout.select_city_item_city, null);
